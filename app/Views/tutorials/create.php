...
<form action="<?= BASE_PATH ?>/tutorials/create" method="POST">
    <div class="form-group">
        <label for="title">Title (Paste a URL and click Fetch to auto-populate)</label>
        <div style="display: flex; gap: 10px;">
            <input type="text" name="title" id="title" required style="flex-grow: 1;">
    ...
    <div class="form-group">
        ...
        <select name="instructor_id" id="instructor_id">
            ...
            <option value="<?= $instructor['instructor_id'] ?>"><?= htmlspecialchars($instructor['first_name'] . ' ' . $instructor['last_name']) ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <div class="form-group">
